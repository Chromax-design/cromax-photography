...
const Funfest = () => {
    return (
        <>
        <Seo title="Esthers fun fest" description="Esthers fun fest page" url="https://cromax-photography-site.vercel.app/funfest" image="https://cromax-photography-site.vercel.app/assets/funfest/funfest 10.jpg" />
